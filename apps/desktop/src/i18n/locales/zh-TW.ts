export default {
  ...
  settings: {
    ...
    customThemeSqlTab: "SQL 語句主題定義",
    customThemeDdlTab: "DDL 比較主題定義",
    customThemeOpacity: "透明度",
    customThemeDdlPreview: "DDL 對比預覽",
    customThemeDdlAddedRow: "新增行背景",
    customThemeDdlRemovedRow: "刪除行背景",
    customThemeDdlModifiedRow: "修改行背景",
    customThemeDdlModifiedChar: "修改字符背景",
