export default {
  ...
  settings: {
    ...
    customThemeSqlTab: "SQL Theme Definition",
    customThemeDdlTab: "DDL Compare Theme",
    customThemeOpacity: "Opacity",
    customThemeDdlPreview: "DDL Compare Preview",
    customThemeDdlAddedRow: "Added Row Background",
    customThemeDdlRemovedRow: "Removed Row Background",
    customThemeDdlModifiedRow: "Modified Row Background",
    customThemeDdlModifiedChar: "Modified Char Background",
