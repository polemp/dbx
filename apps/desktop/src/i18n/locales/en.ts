export default {
  ...
  settings: {
    ...
    routineSourceOpenModeQueryTab: "Query tab",
    routineSourceOpenModeQueryTabDescription: "Open source in a new query tab, same as executing SQL queries.",
    routineSourceOpenModeDialog: "Dialog",
