export default {
  ...
  settings: {
    ...
    customThemeSqlTab: "Definición de tema SQL",
    customThemeDdlTab: "Tema de comparación DDL",
    customThemeOpacity: "Opacidad",
    customThemeDdlPreview: "Vista previa de comparación DDL",
    customThemeDdlAddedRow: "Fondo de fila añadida",
    customThemeDdlRemovedRow: "Fondo de fila eliminada",
    customThemeDdlModifiedRow: "Fondo de fila modificada",
    customThemeDdlModifiedChar: "Fondo de carácter modificado",
